-- Ayakkabı kategorilerini ekle

-- Önce mevcut kategorileri temizle (opsiyonel)
-- DELETE FROM categories;

-- Kategorileri ekle
INSERT INTO categories (id, name, slug, image_url, description, is_active, display_order, created_at, updated_at) VALUES
(UUID(), 'Erkek Ayakkabı', 'erkek-ayakkabi', 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=800&h=800&fit=crop', 'Erkek ayakkabı modelleri', 1, 1, NOW(), NOW()),
...
(UUID(), 'Çocuk Ayakkabı', 'cocuk-ayakkabi', 'https://images.unsplash.com/photo-1514989940723-e8e51635b782?w=800&h=800&fit=crop', 'Çocuk ayakkabı modelleri', 1, 3, NOW(), NOW()),
(UUID(), 'Spor Ayakkabı', 'spor-ayakkabi', 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&h=800&fit=crop', 'Spor ayakkabı modelleri', 1, 4, NOW(), NOW()),
...
(UUID(), 'Topuklu Ayakkabı', 'topuklu-ayakkabi', 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=800&h=800&fit=crop', 'Topuklu ayakkabı modelleri', 1, 9, NOW(), NOW()),
...
(UUID(), 'Futbol Ayakkabısı', 'futbol-ayakkabisi', 'https://images.unsplash.com/photo-1511556532299-8f662fc26c06?w=800&h=800&fit=crop', 'Futbol kramponları ve halı saha ayakkabıları', 1, 11, NOW(), NOW()),
...
SELECT 'Kategoriler başarıyla eklendi!' as result;
